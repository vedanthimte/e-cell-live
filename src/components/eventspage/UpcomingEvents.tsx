...
import illuminate25 from "./pics/illuminate25.jpg";
...
const UpcomingEvents = () => {
  ...
  const events: Array<{
  ...
  }> = [
    {
      ...
      date: "Oct 14, 2025",
      description:
        "🚀 One-day entrepreneurship bootcamp by IIT Bombay experts with dual certificates and startup kit!",
      cta: "Register",
      image: illuminate25,
    },
  ];
    ...
    <section className="w-full bg-[#0E001B] py-26 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {events.length === 0 ? (
          ...
          >
            <div className="bg-[#1C0233] rounded-xl p-12 max-w-2xl mx-auto border border-[#8B5CF6]/20">
              <svg
                className="w-16 h-16 text-[#8B5CF6] mx-auto mb-4"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <p className="text-[#D1D5DB]">
                Stay tuned! We&apos;re planning exciting events. Check back soon for updates.
              </p>
            </div>
          </motion.div>
        ) : (
