          ...
          >
            {filteredPosts.map((post) => (
              <motion.div
                ...
                className="bg-[#1E293B] rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300"
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm font-medium text-[#8B5CF6] hover:text-white px-4 py-2 rounded-full border border-[#8B5CF6] hover:bg-[#8B5CF6] transition-colors"
                    >
                      Read on LinkedIn
                    </a>
                  </div>
